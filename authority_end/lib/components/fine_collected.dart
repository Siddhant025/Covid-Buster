    ...
    _firestore
      ...
      querySnapshot.documents.forEach((element) {
        _firestore
            ...
            .then((QuerySnapshot querySnapshot) {
          setState(() {
            namelength = (querySnapshot.documents.length==null)?0:querySnapshot.documents.length;
          });
        });
      });
    });
