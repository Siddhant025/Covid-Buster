...
import 'package:ibmhack/components/profile.dart';
import 'package:ibmhack/components/faq.dart';
import '../algorithm/algorithm.dart';
import '../components/constants.dart';
import 'package:ibmhack/components/dayscard.dart';
import '../components/qrcodegenerator.dart';
import 'package:geoflutterfire/geoflutterfire.dart';
import 'package:geolocator/geolocator.dart';
import 'package:cloud_firestore/cloud_firestore.dart';
import 'package:rflutter_alert/rflutter_alert.dart';
import 'package:ibmhack/components/tipcard.dart';
                      ...
                      children: <Widget>[
                        IconButton(
                          ...
                          onPressed: (){
                            //TODO: DO;
                            _getCurrentLocation();
                            if(int.parse(totalPeopleAround) < 100 && int.parse(totalPeopleAround)!=1){
                              Alert(context:context, title: "You are Safe!",desc: "There are only ${(int.parse(totalPeopleAround)).toString()} around you.").show();
                            }else if(int.parse(totalPeopleAround) < 100 && int.parse(totalPeopleAround)==1){
                              Alert(context:context, title: "You are Safe!",desc: "There are 0 people around you.").show();
                            }else{
